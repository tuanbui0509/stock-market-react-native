                    ...
                    return (
                        <ScrollView >
                            <View style={{ ...Styles.tableRow, backgroundColor: index % 2 == 1 ? "#F0FBFC" : "white" }}>
                                <Text style={{ ...Styles.columnRowTxtLight, width: '25%' }}>{format(new Date(item.ngayYeuCau), 'dd/MM/yyyy')}</Text>
                                <Text style={{ ...Styles.columnRowTxtLight, width: '25%' }}>{format(new Date(item.ngayBan), 'dd/MM/yyyy')}</Text>
